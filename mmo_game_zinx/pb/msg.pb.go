...
type SyncPid struct {
	...
	Pid           int32                  `protobuf:"varint,1,opt,name=Pid,proto3" json:"Pid,omitempty"` // 服务器生成Pid
...
type BroadCast struct {
	...
	Tp    int32                  `protobuf:"varint,2,opt,name=Tp,proto3" json:"Tp,omitempty"` // 1-世界聊天 2-玩家位置 3-动作 4-移动之后的坐标位置更新
...
type BroadCast_ActionData struct {
	ActionData int32 `protobuf:"varint,5,opt,name=ActionData,proto3,oneof"` //玩家的动作
}
...
const file_msg_proto_rawDesc = "" +
	...
	"\aSyncPid\x12\x10\n" +
	"\x03Pid\x18\x01 \x01(\x05R\x03Pid\"\x91\x01\n" +
	"\tBroadCast\x12\x10\n" +
	...
	"\x01P\x18\x02 \x01(\v2\f.pb.PositionR\x01PB\fZ\x05../pb\xaa\x02\x02Pbb\x06proto3"
